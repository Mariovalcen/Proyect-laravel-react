    ...
    <div className="p-5 flex space-x-2">
          ...
          <div className='flex-1'>
                <div className='flex justify-between items-center'>
                    <div>
                        <span className="text-grey">{post.user.name}</span>
                        <small className="ml-2 text-sm text-grey">{dayjs(post.created_at).fromNow()}</small>
                        ...
                        { post.user.id === auth.user.id &&
                            <Dropdown>
                                <Dropdown.Trigger>
                                    <button>
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-grey" viewBox="0 0 20 20" fill="currentColor">
                ...
                { editing
                    ...
                    : (
                        <>
                            <p className="mt-4 text-lg text-grey">{post.title}</p>
                            <p className="mt-4 text-grey">{post.body}</p>
                        </>
                    )
                }
